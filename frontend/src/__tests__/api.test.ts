...
describe('API tests', () => {
  ...
  it('should update a task', async () => {
    ...
    expect(mockedAxios.put).toHaveBeenCalledWith('http://0.0.0.0:3333/tasks/1', updatedTask);
  });
  ...
  it('should delete a task', async () => {
    ...
    await deleteTask(1);
    expect(mockedAxios.delete).toHaveBeenCalledWith('http://0.0.0.0:3333/tasks/1');
  });
});
